...
<div class="container">
    <div class="row justify-content-center mx-auto mt-4 mb-2">
        <span class="text-center text-info border border-primary border-2 rounded py-2 col-12 col-lg-8"> <?php echo "Compte utilisateur : $login_email" ?></span>
    </div>


    <div class="row justify-content-center mx-auto mb-3">
        <a class="btn btn-outline-primary col-12 col-lg-8 mt-4" data-bs-toggle="modal" data-bs-target="#alias-modal">Définir un nom d'usager.
            <span><i class="bi bi-info-circle col-1" data-bs-toggle="tooltip" title="Par défaut, l'email est utilisé pour identifier l'utilisateur au sein de l'application. Un nom d'usager peut être défini de façon facultative." data-bs-placement="bottom"></i></span>
        </a>
    </div>

    <div class="row justify-content-center mx-auto"> <a class="btn btn-outline-primary mb-3 col-12 col-lg-8" data-bs-toggle="modal" data-bs-target="#password-modal">Changer de mot de passe</a></div>

    <div class="row justify-content-center mx-auto mb-3">
        <a class=" btn btn-outline-primary col-12 col-lg-8 " data-bs-toggle="modal" data-bs-target="#contact-modal">Ajouter une adresse de contact
            <span><i class="bi bi-info-circle col-1" data-bs-toggle="tooltip" title="Il n'est pas possible de changer l'adresse de login, mais une adresse de contact supplémentaire peut être ajoutée." data-bs-placement="bottom"></i></span>
        </a>
    </div>

    <div class="row justify-content-center mx-auto mb-3">
        <a class="btn btn-outline-primary col-12 col-lg-8" data-bs-toggle="modal" data-bs-target="#delay-modal">Modifier le délai de contact
            <span><i class="bi bi-info-circle col-1" data-bs-toggle="tooltip" title="Par défault, l'application envoie un e-mail de rappel une première fois 2 semaines  avant qu'un article arrive à péremption, puis une nouvelle fois trois jours avant." data-bs-placement="bottom"></i></span>
        </a>
    </div>
</div>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <form>
                ...
                <div class="modal-footer">
                    <button class="btn btn-secondary col-12 col-lg-2" type="button" data-bs-dismiss="modal">Annuler</button>
                    <button class="btn btn-primary col-12 col-lg-2" id="password-submit" type="submit" name="new-password">Enregistrer</button>
                </div>
            </form>
        </div>
    </div>
        ...
        <div class="modal-content">
            <form method="post">
                ...
                <div class="modal-body">
                    ...
                    <div class="modal-footer">
                        <button class="btn btn-secondary col-12 col-lg-2" type="button" data-bs-dismiss="modal">Annuler</button>
                        <button class="btn btn-primary col-12 col-lg-2" id="delay-submit" type="submit" name="set-delay">Enregistrer</button>
                    </div>
                </div>
            </form>
        </div>
